    ...
    useEffect(() => {
        const fetchCountryData = async () => {
            try {
                ...
                const response = await axios.get(`http://192.168.250.111:5000/api/country/get/${id}`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                setListing(response.data);
    
                const responseLanguages = await axios.get(`http://192.168.250.111:5000/api/countryInfos/get/country/${id}/category/LANGUAGE`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                ...
                if (categoryCode && selectedCategory !== 'General') {
                    const responseCategory = await axios.get(`http://192.168.250.111:5000/api/countryInfos/get/country/${id}/category/${categoryCode}`, {
                        headers: { Authorization: `Bearer ${token}` }
                    });
